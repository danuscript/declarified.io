...
const hljs = (function () {
  ...
  const w = '[a-zA-Z_]\\w*';
  const y = '\\b\\d+(\\.\\d+)?';
  const _ = '(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)';
  const O = '\\b(0b[01]+)';
  const v = {
  ...
  const S = M('//', '$');
  const R = M('/\\*', '\\*/');
  const j = M('#', '$'); const A = Object.freeze({
    __proto__: null,
  ...
  function $(e, t, n = 'keyword') {
    ...
    let i = 0; const r = e[n]; const s = {}; const
      o = {};
    ...
    function t(t, n) {
      ...
      exec(e) {
        ...
        const n = t.findIndex(((e, t) => t > 0 && void 0 !== e)); const
  ...
  const Y = i; const Q = r; const
    ee = Symbol('nomatch'); const te = ((t) => {
    const i = Object.create(null); const r = Object.create(null); const
      s = []; let o = !0;
    const a = "Could not find the language '{}', did you forget to load/include a language module?"; const
      c = {
      ...
      const c = Object.create(null); function l() {
        ...
        let e = 0; N.keywordPatternRe.lastIndex = 0; let t = N.keywordPatternRe.exec(S); let
          n = '';
        for (; t;) {
          n += S.substring(e, t.index);
          const r = y.case_insensitive ? t[0].toLowerCase() : t[0]; const
            s = (i = r, N.keywords[i]); if (s) {
            const [e, i] = s;
        ...
        let n = 1; const i = t.length - 1; for (; n <= i;) {
          if (!e._emit[n]) { n++; continue; } const i = y.classNameAliases[e[n]] || e[n]; const
            r = t[n];
        ...
        const n = e[0]; const i = t.substring(e.index); const
          r = p(N, e, i); if (!r) return ee; const s = N;
      ...
      let m = {}; function w(i, s) {
        ...
        if (m = s, s.type === 'begin') {
          return ((e) => {
            const t = e[0]; const i = e.rule; const r = new n(i); const
      ...
      t = e; const i = t.textContent; const
...
typeof exports === 'object' && typeof module !== 'undefined' && (module.exports = hljs);/*! `javascript` grammar compiled for Highlight.js 11.6.0 */
(() => {
  const e = (() => {
    ...
    return (o) => {
      const l = o.regex; const b = e; const d = {
        ...
        isTrulyOpeningTag: (e, n) => {
          const a = e[0].length + e.index; const
            t = e.input[a];
          ...
          t === '>' && (((e, { after: n }) => {
            ...
            after: a,
          }) || n.ignoreMatch()), (s = e.input.substring(a).match(/^\s+extends\s+/)) && s.index === 0 && n.ignoreMatch();
        },
      }; const g = {
        $pattern: e, keyword: n, literal: a, built_in: i, 'variable.language': c,
      }; const u = '\\.([0-9](_?[0-9])*)'; const m = '0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*'; const E = {
        className: 'number',
        variants: [{
      ...
      const v = [].concat(f, A.contains); const p = v.concat([{
        begin: /\(/,
        end: /\)/,
        keywords: g,
        ...
        className: { 1: 'keyword', 3: 'title.function' },
        contains: [{ begin: /\(\)/ }, S],
      }; const C = `(\\([^()]*(\\([^()]*(\\([^()]*\\)[^()]*)*\\)[^()]*)*\\)|${o.UNDERSCORE_IDENT_RE})\\s*=>`; const
        M = {
